  ...
  <div class="min-h-screen bg-gray-50 p-3">
    <div class="w-full">
        ...
        >
          <div class="flex flex-col items-center gap-2">
            ...
            <div class="space-y-0.5">
              ...
              <p class="text-xs text-gray-500">or click</p>
            </div>
      ...
      <div v-show="currentSection === 'progress'" class="space-y-3">
        ...
        <p class="text-xs text-gray-600 text-center">{{ progressStatus }}</p>
      </div>
      ...
      <div v-show="currentSection === 'results'" class="space-y-3">
        ...
        <div class="bg-white rounded-lg shadow p-3 space-y-2">
          <p class="text-xs text-gray-600">
            Original: <span class="font-medium text-gray-900">{{ originalSize }}</span>
          </p>
          <p class="text-xs text-gray-600">
            Compressed: <span class="font-medium text-gray-900">{{ compressedSize }}</span>
          </p>
          <p class="text-xs text-gray-600">
            Saved: <span class="font-medium text-green-600">{{ compressionRatio }}</span>
          </p>
        </div>
        <button
        ...
        <button
          class="w-full bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-1.5 px-3 rounded-md text-sm transition-colors"
          @click="reset"
        >
